...
Examples:
  python src/query_index.py "What is this paper about?" --index-name my_index --index-dir ./indexes \
...
async def main_async(
    ...
    try:
        ...
        print(str(e))
        print(
            "Hint: run the indexer first, e.g., python src/index_docs.py --dir ./papers"
        )
        return 1
