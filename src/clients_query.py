...
Examples:
  python src/clients_query.py --title "Augmenting language models with chemistry tools"
  python src/clients_query.py --doi 10.1038/s42256-024-00832-8 --providers all
