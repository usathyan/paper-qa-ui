...
Usage:
  python src/simple_local_qa.py "Your question here"
  python src/simple_local_qa.py "Your question" --config optimized_ollama --files papers/foo.pdf papers/bar.pdf
"""
